...
#define MUX_DEFAULT_OMAP4() \
	...
	MV(CP(USBB1_ULPITLL_DAT1) , ( M7_SAFE | PTD))  /* safe_mode / pulldown */ \
	MV(CP(USBB1_ULPITLL_DAT2) , ( M7_SAFE | PTD))  /* safe_mode / pulldown */ \
	MV(CP(USBB1_ULPITLL_DAT3) , ( M7_SAFE | PTD))  /* safe_mode / pulldown */ \
	MV(CP(USBB1_ULPITLL_DAT4) , ( M7_SAFE | PTD))  /* safe_mode / pulldown */ \
	MV(CP(USBB1_ULPITLL_DAT5) , ( M7_SAFE | PTD))  /* safe_mode / pulldown */ \
	MV(CP(USBB1_ULPITLL_DAT6) , ( M7_SAFE | PTD))  /* safe_mode / pulldown */ \
	MV(CP(USBB1_ULPITLL_DAT7) , ( M7_SAFE | PTD))  /* safe_mode / pulldown */ \
