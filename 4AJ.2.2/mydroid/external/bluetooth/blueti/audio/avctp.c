...
#define DBG(fmt, arg...)  printf("AVCTP: %s: " fmt "\n" , __FUNCTION__ , ## arg)
...
/* TIBLUEZ 1.0 START */
extern gchar *input_device_name;
/* TIBLUEZ 1.0 END */
	...
	if (key_map[i].name == NULL)
       {
		DBG("AV/C: unknown button 0x%02X %s",
            ...
            /*TI-BLUET Start
              Return NOT_IMPLEMENTED on AVRCP command that is unknown*/
...
/* TIBLUEZ 1.0 START */
	...
	session->uinput = uinput_create(uinput_dev_name);
/* TIBLUEZ 1.0 END */
