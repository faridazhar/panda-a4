...
nfc_s8 *dbg_rf_mgmt_strs[] =
{
	...
	"NCI_OPCODE_RF_INTF_ACTIVATED",
	"NCI_OPCODE_RF_DEACTIVATE",
	"NCI_OPCODE_RF_RF_FIELD_INFO",
	"NCI_OPCODE_RF_T3T_POLLING",
	"NCI_OPCODE_RF_NFCEE_ACTION",
	"NCI_OPCODE_RF_NFCEE_DISCOVERY_REQ",
	"NCI_OPCODE_RF_PARAMETER_UPDATE",
};
...
dbg_tlv_t dbg_tlv_data[] =
{
	...
	{NCI_CFG_TYPE_PB_ATTRIB_PARAM,"NCI_CFG_TYPE_PB_ATTRIB_PARAM"},

	{NCI_CFG_TYPE_PF_BIT_RATE			,"NCI_CFG_TYPE_PF_BIT_RATE"},

	{NCI_CFG_TYPE_PB_H_INFO			,"NCI_CFG_TYPE_PB_H_INFO"},
	{NCI_CFG_TYPE_PI_BIT_RATE			,"NCI_CFG_TYPE_PI_BIT_RATE"},

	{NCI_CFG_TYPE_PN_NFC_DEP_SPEED			,"NCI_CFG_TYPE_PN_NFC_DEP_SPEED"},
	{NCI_CFG_TYPE_PN_ATR_REQ_GEN_BYTES			,"NCI_CFG_TYPE_PN_ATR_REQ_GEN_BYTES"},
	{NCI_CFG_TYPE_PN_ATR_REQ_CONFIG			,"NCI_CFG_TYPE_PN_ATR_REQ_CONFIG"},

	{NCI_CFG_TYPE_LA_BIT_FRAME_SDD		,"NCI_CFG_TYPE_LA_BIT_FRAME_SDD"},
	{NCI_CFG_TYPE_LA_PLATFORM_CONFIG	,"NCI_CFG_TYPE_LA_PLATFORM_CONFIG"},
	{NCI_CFG_TYPE_LA_SEL_INFO	,"NCI_CFG_TYPE_LA_SEL_INFO"},
	{NCI_CFG_TYPE_LA_NFCID1	,"NCI_CFG_TYPE_LA_NFCID1"},

	{NCI_CFG_TYPE_LB_SENSB_INFO			,"NCI_CFG_TYPE_LB_SENSB_INFO"},
	...
	{NCI_CFG_TYPE_LF_PROTOCOL_TYPE		,"NCI_CFG_TYPE_LF_PROTOCOL_TYPE1"},
	{NCI_CFG_TYPE_LF_T3T_FLAGS2			,"NCI_CFG_TYPE_LF_T3T_FLAGS2"},
	{NCI_CFG_TYPE_LF_CON_BITR_F			,"NCI_CFG_TYPE_LF_CON_BITR_F"},


	{NCI_CFG_TYPE_LI_FWI					,"NCI_CFG_TYPE_LI_FWI"},
	{NCI_CFG_TYPE_LA_HIST_BY			,"NCI_CFG_TYPE_LA_HIST_BY"},
	{NCI_CFG_TYPE_LB_H_INFO_RESP		,"NCI_CFG_TYPE_LB_H_INFO_RESP"},
	{NCI_CFG_TYPE_LI_BIT_RATE			,"NCI_CFG_TYPE_LI_BIT_RATE"},


	{NCI_CFG_TYPE_LN_WT						,"NCI_CFG_TYPE_LN_WT"},
	{NCI_CFG_TYPE_LN_ATR_RES_GEN_BYTES			,"NCI_CFG_TYPE_LN_ATR_RES_GEN_BYTES"},
	{NCI_CFG_TYPE_LN_ATR_RES_CONFIG			,"NCI_CFG_TYPE_LN_ATR_RES_CONFIG"},
...
void ncidev_log(struct ncidev *p_ncidev, struct nci_buff *p_buff, char *p_prefix)
{
	...
	switch (mt)
	{
		case NCI_MT_DATA:
		{
			...
			/* Amir: NCI Payload (DATA) dump buffer */
			osa_report (INFORMATION,("   NCI Payload (DATA, data_len = %d)", data_len));
			for (i=0; i<data_len; i++)
			{
				osa_report (INFORMATION, ("[%d] = %x", i, p_hdr[header_len+i]));
			}
		...
		default: /* Control */
		{
			...
			/* Amir: NCI Payload (CTRL) dump buffer*/
			osa_report (INFORMATION,("   NCI Payload (CTRL, data_len = %d)", data_len));
			for (i=0; i<data_len; i++)
			{
				osa_report (INFORMATION, ("[%d] = %x", i, p_hdr[header_len+i]));
			}
