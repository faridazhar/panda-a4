...
NFCSTATUS phDal4Nfc_Unregister(void *pContext, void *pHwRef )
{
	...
	DAL_PRINT("phDal4Nfc_Unregister");
...
extern void phHal4Nfc_Destroy(void* context);
...
extern void* phHal4Nfc_Create(void);
/*-----------------------------------------------------------------------------
