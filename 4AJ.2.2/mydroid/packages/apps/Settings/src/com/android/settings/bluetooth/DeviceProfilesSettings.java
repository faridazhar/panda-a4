...
public final class DeviceProfilesSettings extends SettingsPreferenceFragment
    ...
    private CheckBoxPreference createProfilePreference(LocalBluetoothProfile profile) {
        Log.d(TAG, "createProfilePreference(): " + profile.getNameResource(mCachedDevice.getDevice()));
    ...
    private void onProfileClicked(LocalBluetoothProfile profile) {
        ...
        Log.d(TAG, "onProfileClicked(): device " + device.getAddress() + ", status " + status);
        boolean isConnected =
    ...
    private void refreshProfilePreference(CheckBoxPreference profilePref,
        ...
        Log.d(TAG, "refreshProfilePreference(): " +
                profile.getNameResource(mCachedDevice.getDevice()) +
                " isPreferred " + profile.isPreferred(device));
