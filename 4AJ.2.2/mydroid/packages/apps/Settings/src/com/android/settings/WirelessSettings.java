...
public class WirelessSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_TOGGLE_BLUETOOTH_DUN = "toggle_bluetooth_dun"; // BLUETI_ENHANCEMENT
    ...
    private BluetoothDunEnabler mBluetoothDunEnabler; // BLUETI_ENHANCEMENT
    private CheckBoxPreference mBluetoothDunPreference; // BLUETI_ENHANCEMENT
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (SystemProperties.BLUETI_ENHANCEMENT) {
            mBluetoothDunPreference =
                    (CheckBoxPreference) findPreference(KEY_TOGGLE_BLUETOOTH_DUN);
            mBluetoothDunEnabler = new BluetoothDunEnabler(activity, mBluetoothDunPreference);
        }
    ...
    public void onResume() {
        ...
        if (SystemProperties.BLUETI_ENHANCEMENT) {
             if (mBluetoothDunEnabler != null) {
                mBluetoothDunEnabler.resume();
            }
        }
