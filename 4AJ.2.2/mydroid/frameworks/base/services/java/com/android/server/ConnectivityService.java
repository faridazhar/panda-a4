    ...
    public ConnectivityService(Context context, INetworkManagementService netd,
        ...
        for (int netType : mPriorityList) {
            ...
            case ConnectivityManager.TYPE_ETHERNET:
                if (SystemProperties.OMAP_ENHANCEMENT && context.getPackageManager().hasSystemFeature(PackageManager.FEATURE_ETHERNET)) {
                    mNetTrackers[netType] = TIEthernetDataTracker.getInstance();
                } else {
