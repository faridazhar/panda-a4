...
import android.server.BluetoothGattClientService;  // BLUETI_ENHANCEMENT
import android.server.BluetoothGattServerService;  // BLUETI_ENHANCEMENT
...
class ServerThread extends Thread {
    ...
    public void run() {
        ...
        BluetoothGattClientService bluetoothGattClient = null;  // BLUETI_ENHANCEMENT
        BluetoothGattServerService bluetoothGattServer = null;  // BLUETI_ENHANCEMENT
        ...
        try {
            ...
            if (SystemProperties.get("ro.kernel.qemu").equals("1")) {
                ...
                if (SystemProperties.BLUETI_ENHANCEMENT) {
                    bluetoothGattClient = new BluetoothGattClientService(context, bluetooth);
                    ServiceManager.addService(BluetoothGattClientService.BLUETOOTH_GATTCLIENT_SERVICE,
                            bluetoothGattClient);
                }


                if (SystemProperties.BLUETI_ENHANCEMENT) {
		    bluetoothGattServer = new BluetoothGattServerService(context, bluetooth);  // BLUETI_ENHANCEMENT
                    ServiceManager.addService(BluetoothGattServerService.BLUETOOTH_GATTSERVER_SERVICE,
                            bluetoothGattServer);
		}
