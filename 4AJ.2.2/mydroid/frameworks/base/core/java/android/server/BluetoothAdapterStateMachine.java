...
final class BluetoothAdapterStateMachine extends StateMachine {
    ...
    // Bluetooth scan mode change timeout happens
    private static final int SCAN_MODE_CHANGE_TIMEOUT = 107;  // BLUETI_ENHANCEMENT
    ...
    private static final int SCAN_MODE_CHANGE_TIMEOUT_TIME = 3000;  // BLUETI_ENHANCEMENT
        ...
        public boolean processMessage(Message message) {
            ...
            switch(message.what) {
                ...
                case TURN_ON_CONTINUE:
                    ...
                    if (SystemProperties.BLUETI_ENHANCEMENT)
                        sendMessageDelayed(SCAN_MODE_CHANGE_TIMEOUT,
                                            SCAN_MODE_CHANGE_TIMEOUT_TIME);
                        ...
                        if (mPublicState == BluetoothAdapter.STATE_TURNING_OFF) {
                            ...
                            if (SystemProperties.BLUETI_ENHANCEMENT) {
                                if (Settings.Secure.getInt(mContext.getContentResolver(),
                                    ...
                                    mBluetoothService.enableBluetoothDun(true);
                                }
                            }
