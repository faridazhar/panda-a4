...
public class VolumePanel extends Handler implements OnSeekBarChangeListener, View.OnClickListener
{
    ...
    private enum StreamResources {
        ...
        BluetoothAVRCPStream(AudioManager.STREAM_BLUETOOTH_AVRCP1_4,    // BLUETI_ENHANCEMENT
                R.string.volume_icon_description_bluetooth,
                R.drawable.ic_audio_bt,
                R.drawable.ic_audio_bt,
                false);
    ...
    private static final StreamResources[] STREAMS = {
        ...
        StreamResources.BluetoothAVRCPStream    // BLUETI_ENHANCEMENT
    };
...
//                setRingerIcon();
            ...
            case AudioManager.STREAM_BLUETOOTH_AVRCP1_4: {    // BLUETI_ENHANCEMENT
                // To Do: Change the icon to mute in case the index equals 0
                break;
            }
        }
