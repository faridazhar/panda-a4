...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
         ...
         * @hide
         */
         public static final String VOLUME_BLUETOOTH_AVRCP1_4 = "volume_bluetooth_avrcp1_4";    // BLUETI_ENHANCEMENT
        ...
        public static final String[] VOLUME_SETTINGS = {
            ...
            VOLUME_BLUETOOTH_AVRCP1_4 // BLUETI_ENHANCEMENT
        };
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
            ...
            VOLUME_BLUETOOTH_AVRCP1_4+ APPEND_FOR_LAST_AUDIBLE,    // BLUETI_ENHANCEMENT
            TEXT_AUTO_REPLACE,
            TEXT_AUTO_CAPS,
            TEXT_AUTO_PUNCTUATE,
            TEXT_SHOW_PASSWORD,
    ...
    public static final class Secure extends NameValueTable {
        ...
        public static final String getBluetoothInputDevicePriorityKey(String address) {
         ...
         /**
         * BLUETI_ENHANCEMENT-
         * Get the key that retrieves a bluetooth Att Device's priority.
         * @hide
         */
        public static final String getBluetoothAttPriorityKey(String address) {
            return ("bluetooth_att_priority_" + address.toUpperCase());
        }

        /**
         * BLUETI_ENHANCEMENT-
         * Get the key that retrieves a Bluetooth DUN Device's priority.
         * @hide
         */
        public static final String getBluetoothDunDevicePriorityKey(String address) {
            return ("bluetooth_dun_priority_" + address.toUpperCase());
        }
        ...
        /**
         * Constant to specify whether Bluetooth DUN is enabled.
         * @hide
         */
        public static final String ENABLE_BLUETOOTH_DUN_SETTING = "enable_bluetooth_dun_setting"; // BLUETI_ENHANCEMENT
