...
import java.lang.reflect.*;  // BLUETI_ENHANCEMENT
...
public final class BatteryStatsImpl extends BatteryStats {
    ...
    public void setBtHeadset(BluetoothHeadset headset) {
        ...
        if(SystemProperties.BLUETI_ENHANCEMENT) {
            // Make sure we close the headset no matter what
            if (mBtHeadset != null && mBtHeadset != headset) {
                // BLUETI_ENHANCMENT reflect close() hidden Method from BluetoothHeadset
                String  closeName = "close";
                try {
                    Method  closeMethode =
                        mBtHeadset.getClass().getMethod(closeName, BluetoothHeadset.class);
                    try {
                        closeMethode.invoke(mBtHeadset);
