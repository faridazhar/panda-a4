...
extern int register_com_ti_bluetooth_BluetoothGattClient(JNIEnv *env);
extern int register_com_ti_bluetooth_BluetoothGattServer(JNIEnv *env);
...
#ifdef BLUETI_ENHANCEMENT
    REG_JNI(register_com_ti_bluetooth_BluetoothGattClient),
    REG_JNI(register_com_ti_bluetooth_BluetoothGattServer),
#endif /*BLUETI_ENHANCEMENT*/
};
