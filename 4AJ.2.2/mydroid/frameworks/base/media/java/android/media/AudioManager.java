...
public class AudioManager {
    ...
    public static final String ACTION_AUDIO_BECOMING_NOISY = "android.media.AUDIO_BECOMING_NOISY";
     ...
     /**
     * BLUETI_ENHANCEMENT-
     * Broadcast intent, to request the Mediaplayer resync our lower layers with its play
     * Postition and status
     * @hide
     */
    public static final String ACTION_UPDATE_NATIVE_STATUS = "android.media.UPDATE_NATIVE_STATUS";
     ...
     * @hide The previous master volume value for the master volume changed intent.
     * Value is integer between 0 and 100 inclusive.
     * Broadcast intent when the the current media playback status changed.
     * Includes the playback status and the elapsed time of the media.
     * Applications do not send this intent directly. Rather they call
     * setCurrentMediaPlaybackStatus(int, long), which is responsible
     * for broadcasting the change.
     *
     * see also:
     * setCurrentMediaPlaybackStatus(int, long)
     * EXTRA_MEDIA_PLAYBACK_STATUS
     * EXTRA_MEDIA_PLAYBACK_ELAPSED
     * @hide
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_MEDIA_PLAYBACK_CHANGED = "android.media.ACTION_MEDIA_PLAYBACK_CHANGED";

    /**
     * Broadcast intent Android needs the application to re-send the current
     * playback status. This is mainly to ensure the time elapsed of the track
     * does not keep out of sync, so it eventually ask the application to re-set
     * this. Application should listen to this broadcast and call
     * setCurrentMediaPlaybackStatus(int, long.
     *
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_MEDIA_PLAYBACK_REQUESTED = "android.media.ACTION_MEDIA_PLAYBACK_REQUESTED";

    /**
     * The media playback status
     * @hide
     */
    public static final String EXTRA_MEDIA_PLAYBACK_STATUS = "android.media.EXTRA_MEDIA_PLAYBACK_STATUS";

    /** @hide */
    public static final int MEDIA_PLAYBACK_STATUS_PLAYING = 0;

    /** @hide */
    public static final int MEDIA_PLAYBACK_STATUS_STOPPED = 1;

    /** @hide */
    public static final int MEDIA_PLAYBACK_STATUS_PAUSED = 2;

    /** @hide */
    public static final int MEDIA_PLAYBACK_STATUS_FORWARD_SEEK = 3;

    /** @hide */
    public static final int MEDIA_PLAYBACK_STATUS_REVERSE_SEEK = 4;

    /**
     * The media playback elapsed time
     * @hide
     */
    public static final String EXTRA_MEDIA_PLAYBACK_ELAPSED = "android.media.EXTRA_MEDIA_PLAYBACK_ELAPSED";

    /**
     * Broadcast intent when the the current media track changed.  Includes the
     * media metadata as a Bundle.
     * @hide
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_MEDIA_CHANGED = "android.media.ACTION_MEDIA_CHANGED";

    /**
     * The title of the media currently selected
     * @hide
     */
    public static final String EXTRA_MEDIA_TITLE = "android.media.EXTRA_MEDIA_TITLE";

    /**
     * The artist of the media currently selected
     * @hide
     */
    public static final String EXTRA_MEDIA_ARTIST = "android.media.EXTRA_MEDIA_ARTIST";

    /**
     * The album of the media currently selected
     * @hide
     */
    public static final String EXTRA_MEDIA_ALBUM = "android.media.EXTRA_MEDIA_ALBUM";

    /**
     * The genre of the media currently selected
     * @hide
     */
    public static final String EXTRA_MEDIA_GENRE = "android.media.EXTRA_MEDIA_GENRE";

    /**
     * The number of tracks of the media currently selected
     * @hide
     */
    public static final String EXTRA_MEDIA_NUMBER_OF_TRACKS = "android.media.EXTRA_MEDIA_NUMBER_OF_TRACKS";

    /**
     * The track number of the media currently selected
     * @hide
     */
    public static final String EXTRA_MEDIA_TRACK_NUMBER = "android.media.EXTRA_MEDIA_NUMBER";

    /**
     * The track duration of the media currently selected
     * @hide
     */
    public static final String EXTRA_MEDIA_TRACK_DURATION = "android.media.EXTRA_MEDIA_DURATION";

    /**
     * Broadcast intent when the the current player setting changed.
     * Includes the player setting that has changed
     * @hide
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_MEDIA_PLAYER_SETTINGS_CHANGED = "android.media.ACTION_MEDIA_PLAYER_SETTINGS_CHANGED";

    /** @hide */
    public static final String MEDIA_PLAYER_SETTING_EQUALIZER = "android.media.EXTRA_MEDIA_PLAYER_SETTING_EQUALIZER";

    /** @hide */
    public static final int MEDIA_PLAYER_EQUALIZER_MODE_OFF = 0;

    /** @hide */
    public static final int MEDIA_PLAYER_EQUALIZER_MODE_ON = 1;

    /** @hide */
    public static final String MEDIA_PLAYER_SETTING_REPEAT = "android.media.MEDIA_PLAYER_SETTING_REPEAT";

    /** @hide */
    public static final int MEDIA_PLAYER_REPEAT_MODE_OFF = 0;

    /** @hide */
    public static final int MEDIA_PLAYER_REPEAT_MODE_SINGLETRACK = 2;

    /** @hide */
    public static final int MEDIA_PLAYER_REPEAT_MODE_ALLTRACKS = 3;

    /** @hide */
    public static final int MEDIA_PLAYER_REPEAT_MODE_GROUP = 4;

    /** @hide */
    public static final String MEDIA_PLAYER_SETTING_SHUFFLE = "android.media.MEDIA_PLAYER_SETTING_SHUFFLE";

    /** @hide */
    public static final int MEDIA_PLAYER_SHUFFLE_MODE_OFF = 0;

    /** @hide */
    public static final int MEDIA_PLAYER_SHUFFLE_MODE_ALLTRACKS = 3;

    /** @hide */
    public static final int MEDIA_PLAYER_SHUFFLE_MODE_GROUP = 4;

    /** @hide */
    public static final String MEDIA_PLAYER_SETTING_SCAN = "android.media.MEDIA_PLAYER_SETTING_SCAN";

    /** @hide */
    public static final int MEDIA_PLAYER_SCAN_MODE_OFF = 0;

    /** @hide */
    public static final int MEDIA_PLAYER_SCAN_MODE_ALLTRACKS = 3;

    /** @hide */
    public static final int MEDIA_PLAYER_SCAN_MODE_GROUP = 4;
    ...
    /** @hide The audio stream for music when connected to AVRCP1.4 */
    public static final int STREAM_BLUETOOTH_AVRCP1_4 = AudioSystem.STREAM_BLUETOOTH_AVRCP1_4;    // BLUETI_ENHANCEMENT
     ...
     * @hide
     */
    public static final String ABSOLUTE_VOLUME_SETTING_AVRCP_1_4 = "android.media. ABSOLUTE_VOLUME_SETTING_AVRCP_1_4";    // BLUETI_ENHANCEMENT

    private static IAudioService sService;

    // BLUETI_ENHANCEMENT - Start
    private static boolean mAvrcp1_4Flag = false;

     /**
     * @hide
     */
    public static boolean avrcp1_4Active() {
        return mAvrcp1_4Flag;
    }

     /**
     * @hide
     */
    public static void remoteSupportsAvrcp1_4(boolean state) {
         mAvrcp1_4Flag = state;
    }
    // BLUETI_ENHANCEMENT - End
    ...
    */
    ...
    /**
     * BLUETI_ENHANCEMENT-
     * Register a component to receive MEDIA_PLAYER intents.
     * @param eventReceiver identifier of a {@link android.content.BroadcastReceiver}
     *      that will receive the media button intent. This broadcast receiver must be declared
    ...
    /**
     * BLUETI_ENHANCEMENT-
     * Unregister the receiver of MEDIA_PLAYER intents.
     * @param eventReceiver identifier of a {@link android.content.BroadcastReceiver}
     *      that was registered with {@link #registerMediaPlayerEventReceiver(ComponentName)}.
     * @hide
     */
    ...
    /**
     * BLUETI_ENHANCEMENT-
     * Set the current player setting
     *
     * @param settings a bundle with the following keys:
     *     {@link #MEDIA_PLAYER_SETTING_EQUALIZER},
     *     {@link #MEDIA_PLAYER_SETTING_REPEAT},
     *     {@link #MEDIA_PLAYER_SETTING_SHUFFLE},
     *     {@link #MEDIA_PLAYER_SETTING_SCAN}. Keys not used are treated as
     *     not changed.
     * @hide
     */
