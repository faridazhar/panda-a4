...
interface IAudioService {
    ...
    void registerMediaPlayerEventReceiver(in ComponentName eventReceiver);  // BLUETI_ENHANCEMENT

    void unregisterMediaPlayerEventReceiver(in ComponentName eventReceiver);  // BLUETI_ENHANCEMENT

    void setCurrentMedia(in Bundle metadata);  // BLUETI_ENHANCEMENT

    void setCurrentMediaPlaybackStatus(int status, long elapsed);  // BLUETI_ENHANCEMENT

    void setCurrentMediaPlayerSettings(in Bundle settings);  // BLUETI_ENHANCEMENT
